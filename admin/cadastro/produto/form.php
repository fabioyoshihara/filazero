...
<main>
    ...
    <section class="container-form">
        ...
        <form method="post" enctype="multipart/form-data">
            <label for="codigoLoja">Loja</label>
            <select name="codigoLoja" id="codigoLoja">
                <?php foreach ($lojas as $loja): ?>
                    <option value="<?= $loja->getCodigo() ?>"><?= $loja->getNome() ?></option>
                <?php endforeach; ?>
            </select>
            ...
            <input type="text" id="preco" name="preco" placeholder="Digite uma preço" required>

            <label for="tamanho">Tamanho</label>
            <input type="text" id="tamanho" name="tamanho" placeholder="Digite um tamanho" required>

            <label for="tempo">Tempo</label>
            <input type="text" id="tempo" name="tempo" placeholder="Digite um tempo de preparo" required>
