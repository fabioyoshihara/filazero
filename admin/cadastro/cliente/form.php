...
<head>
    ...
    <title>filazero - Cadastro de Clientes</title>
</head>
<body>
<main>
    ...
    <section class="container-form">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="celular" placeholder="Digite o número do celular com ddd (só números)" required>
            ...
            <input type="submit" name="cadastrocliente" class="botao-cadastrar" value="Cadastrar cliente"/>
        </form>
