    ...
    <main>
          ...
          <section class="container-table">
            <form action="#">
               ...
               <input type="cpf" id="cpf" placeholder="Digite o seu CPF" required>
               <label for="senha">Senha</label>
               <input type="password" id="senha" placeholder="Digite a sua senha" required>
               <input type="submit" class="botao-cadastrar" value="Entrar"/><br>
               <a href="recuperar_senha_loja.php">esqueci minha senha</a>                 
            </form>
