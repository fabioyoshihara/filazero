...
<head>
  ...
  <title>Filazero - Recuperar Senha</title>
</head>
<body>
<main>
  ...
  <form action="#">
    ...
    <input type="password" id="password" placeholder="Digite a sua nova senha" required>
  ...
  <section class="container-table">
      ...
      <a href="/admin/cadastro/cliente/form.php">Novo Cadastro</a>
  </section> 
